...
//visibleInputs.length = 0
                ...
                errors_setFunctionError(err,userTemplate_logNameFile,"function hideFalseInputs");
            }
        }
        ...
        function  createWorkspace(prefs){
            ...
            try{
                 ...
                 //visibleInputs.length = 0
                    ...
                    function removeLastChilds (){
                        try{ 
                            ...
                            errors_setFunctionError(err,userTemplate_logNameFile,"function createWorkspace => removeLastChilds");
                        }
                    }
                    ...
                    function createChilds(){
                        ...
                        try{ 
                            ...
                            errors_setFunctionError(err,userTemplate_logNameFile,"function createWorkspace => createChilds");
                        }
                    }
                ...
                errors_setFunctionError(err,userTemplate_logNameFile,"function createWorkspace");
            }
        }
